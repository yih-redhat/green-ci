...
case "${ID}-${VERSION_ID}" in
    "fedora-40")
        ...
        BASE_IMAGE_URL="quay.io/fedora/fedora-bootc:40"
...
sudo rpm-ostree install -A podman qemu-img firewalld qemu-kvm libvirt-client libvirt-daemon-kvm libvirt-daemon virt-install rpmdevtools
